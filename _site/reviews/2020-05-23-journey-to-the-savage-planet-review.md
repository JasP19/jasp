...
## Journey to the (Slightly) Savage Planet
...
The best part about the alien world is the stunning visuals which are colourful and eye-catching. There is also an excellent photo mode that lets avid players snap pictures with all the weird and wonderful creatures which are found across the alien landscape. One last little addition is a filter mode which lets you change art styles on the fly. The novelty does wear off pretty quickly and some of the filters make the game look terrible but it's a neat feature which doesn't go unnoticed. 
